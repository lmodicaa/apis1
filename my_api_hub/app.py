...
from my_api_hub.bot import start_bot

# --- CONFIGURATION ---
SECRET_KEY = os.environ.get("SECRET_KEY", "a_very_strong_secret_key_for_apihub_12345")
BOT_USERNAME = os.environ.get("BOT_USERNAME", "SnoopDoggCC_Bot")
...
<head>
    ...
    <title>Access Required - ApiHub</title>
    <script src="https://cdn.jsdelivr.net/npm/feather-icons/dist/feather.min.js"></script>
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap');
        body{font-family:'Inter',sans-serif;background-color:#0d1117;color:#c9d1d9;
             display:flex;justify-content:center;align-items:center;height:100vh;margin:0;}
        .access-container{background:rgba(22,27,34,0.8);padding:40px;border-radius:20px;
             text-align:center;border:1px solid rgba(255,255,255,0.15);max-width:450px;width:100%;}
        input{width:100%;padding:15px;background:rgba(0,0,0,0.2);border:1px solid rgba(255,255,255,0.15);
             border-radius:12px;color:#c9d1d9;font-size:1.5rem;text-align:center;letter-spacing:5px;margin-bottom:20px;}
        .btn{padding:14px 22px;border-radius:12px;border:none;font-weight:600;cursor:pointer;
             display:flex;align-items:center;justify-content:center;gap:10px;font-size:1rem;width:100%;
             text-decoration:none;transition:all 0.3s ease;}
        .btn-primary{background:#8A2BE2;color:white;margin-top:20px;}
        .btn-telegram{background-color:#2AABEE;color:white;margin-bottom:30px;}
...
<body>
    <div class="access-container">
        ...
        <a href="https://t.me/{{ bot_username }}" target="_blank" class="btn btn-telegram"><i data-feather="send"></i> Get Access Code Here</a>
        <form id="verify-form">
